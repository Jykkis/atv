...
__attribute__((section("__versions"))) = {
	...
	{ 0x626a5eea, __VMLINUX_SYMBOL_STR(dma_set_mask) },
	...
	{ 0xba539006, __VMLINUX_SYMBOL_STR(pci_set_master) },
	...
	{ 0xfe52f9ce, __VMLINUX_SYMBOL_STR(pci_clear_master) },
...
MODULE_INFO(srcversion, "F85BE54B0B1EB3737FCAD17");
