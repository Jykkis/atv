...
if("TRUE" STREQUAL "TRUE")
  set(image_geometry_SOURCE_PREFIX /home/atv/atv-project-2017/catkin_ws/src/vision_opencv-kinetic/image_geometry)
  set(image_geometry_DEVEL_PREFIX /home/atv/atv-project-2017/catkin_ws/devel)
  ...
  set(image_geometry_INSTALL_PREFIX /home/atv/atv-project-2017/catkin_ws/install)
...
if(NOT "/home/atv/atv-project-2017/catkin_ws/src/vision_opencv-kinetic/image_geometry/include;/usr/local/include/opencv;/usr/local/include " STREQUAL " ")
  set(image_geometry_INCLUDE_DIRS "")
  set(_include_dirs "/home/atv/atv-project-2017/catkin_ws/src/vision_opencv-kinetic/image_geometry/include;/usr/local/include/opencv;/usr/local/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'image_geometry' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/atv/atv-project-2017/catkin_ws/src/vision_opencv-kinetic/image_geometry/${idir}'.  Ask the maintainer 'Vincent Rabaud <vincent.rabaud@gmail.com>' to fix it.")
    endif()
    _list_append_unique(image_geometry_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "image_geometry;/usr/local/lib/libopencv_videostab.so.2.4.9;/usr/local/lib/libopencv_video.so.2.4.9;/usr/local/lib/libopencv_superres.so.2.4.9;/usr/local/lib/libopencv_stitching.so.2.4.9;/usr/local/lib/libopencv_photo.so.2.4.9;/usr/local/lib/libopencv_ocl.so.2.4.9;/usr/local/lib/libopencv_objdetect.so.2.4.9;/usr/local/lib/libopencv_nonfree.so.2.4.9;/usr/local/lib/libopencv_ml.so.2.4.9;/usr/local/lib/libopencv_legacy.so.2.4.9;/usr/local/lib/libopencv_imgproc.so.2.4.9;/usr/local/lib/libopencv_highgui.so.2.4.9;/usr/local/lib/libopencv_gpu.so.2.4.9;/usr/local/lib/libopencv_flann.so.2.4.9;/usr/local/lib/libopencv_features2d.so.2.4.9;/usr/local/lib/libopencv_core.so.2.4.9;/usr/local/lib/libopencv_contrib.so.2.4.9;/usr/local/lib/libopencv_calib3d.so.2.4.9")
