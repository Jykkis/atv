...
"""
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.exposure_given,) = _struct_B.unpack(str[start:end])
      ...
      (self.gain_given,) = _struct_B.unpack(str[start:end])
      ...
      (self.gamma_given,) = _struct_B.unpack(str[start:end])
      ...
      (self.brightness_given,) = _struct_B.unpack(str[start:end])
      ...
      (_x.exposure_auto, _x.gain_auto,) = _struct_2B.unpack(str[start:end])
