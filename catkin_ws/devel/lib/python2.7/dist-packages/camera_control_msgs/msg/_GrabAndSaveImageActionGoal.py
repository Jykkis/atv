...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_BfBfBfBf2B.pack(_x.goal.exposure_given, _x.goal.exposure_time, _x.goal.gain_given, _x.goal.gain_value, _x.goal.gamma_given, _x.goal.gamma_value, _x.goal.brightness_given, _x.goal.brightness_value, _x.goal.exposure_auto, _x.goal.gain_auto))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.goal.exposure_given, _x.goal.exposure_time, _x.goal.gain_given, _x.goal.gain_value, _x.goal.gamma_given, _x.goal.gamma_value, _x.goal.brightness_given, _x.goal.brightness_value, _x.goal.exposure_auto, _x.goal.gain_auto,) = _struct_BfBfBfBf2B.unpack(str[start:end])
