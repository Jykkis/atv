...
"""
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.goal.exposure_given,) = _struct_B.unpack(str[start:end])
      ...
      (_x.goal.exposure_fixed, _x.goal.brightness_given,) = _struct_2B.unpack(str[start:end])
      ...
      (_x.goal.brightness_continuous, _x.goal.gain_given,) = _struct_2B.unpack(str[start:end])
      ...
      (_x.goal.gain_fixed, _x.goal.gamma_given,) = _struct_2B.unpack(str[start:end])
