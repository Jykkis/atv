...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_BfBfBfBf2B.pack(_x.exposure_given, _x.exposure_time, _x.gain_given, _x.gain_value, _x.gamma_given, _x.gamma_value, _x.brightness_given, _x.brightness_value, _x.exposure_auto, _x.gain_auto))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.exposure_given, _x.exposure_time, _x.gain_given, _x.gain_value, _x.gamma_given, _x.gamma_value, _x.brightness_given, _x.brightness_value, _x.exposure_auto, _x.gain_auto,) = _struct_BfBfBfBf2B.unpack(str[start:end])
