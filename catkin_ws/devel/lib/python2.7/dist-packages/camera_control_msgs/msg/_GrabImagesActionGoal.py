...
"""
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.goal.gain_given,) = _struct_B.unpack(str[start:end])
      ...
      (self.goal.gamma_given,) = _struct_B.unpack(str[start:end])
      ...
      (self.goal.brightness_given,) = _struct_B.unpack(str[start:end])
      ...
      (_x.goal.exposure_auto, _x.goal.gain_auto,) = _struct_2B.unpack(str[start:end])
