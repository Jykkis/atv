...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_struct_B.pack(self.action_goal.goal.gain_given))
      length = len(self.action_goal.goal.gain_values)
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(struct.pack(pattern, *self.action_goal.goal.gain_values))
      buff.write(_struct_B.pack(self.action_goal.goal.gamma_given))
      length = len(self.action_goal.goal.gamma_values)
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(struct.pack(pattern, *self.action_goal.goal.gamma_values))
      buff.write(_struct_B.pack(self.action_goal.goal.brightness_given))
      length = len(self.action_goal.goal.brightness_values)
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(struct.pack(pattern, *self.action_goal.goal.brightness_values))
      _x = self
      buff.write(_struct_2B3I.pack(_x.action_goal.goal.exposure_auto, _x.action_goal.goal.gain_auto, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.action_goal.goal.gain_given,) = _struct_B.unpack(str[start:end])
      ...
      (self.action_goal.goal.gamma_given,) = _struct_B.unpack(str[start:end])
      ...
      (self.action_goal.goal.brightness_given,) = _struct_B.unpack(str[start:end])
      ...
      (_x.action_goal.goal.exposure_auto, _x.action_goal.goal.gain_auto, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _struct_2B3I.unpack(str[start:end])
