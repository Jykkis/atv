...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_struct_2B.pack(_x.exposure_fixed, _x.brightness_given))
      length = len(self.brightness_values)
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(struct.pack(pattern, *self.brightness_values))
      _x = self
      buff.write(_struct_2B.pack(_x.brightness_continuous, _x.gain_given))
      length = len(self.gain_values)
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(struct.pack(pattern, *self.gain_values))
      _x = self
      buff.write(_struct_2B.pack(_x.gain_fixed, _x.gamma_given))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.exposure_fixed, _x.brightness_given,) = _struct_2B.unpack(str[start:end])
      ...
      (_x.brightness_continuous, _x.gain_given,) = _struct_2B.unpack(str[start:end])
      ...
      (_x.gain_fixed, _x.gamma_given,) = _struct_2B.unpack(str[start:end])
