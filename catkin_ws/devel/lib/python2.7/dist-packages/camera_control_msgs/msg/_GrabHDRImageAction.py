...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_struct_3I.pack(_x.action_result.result.hdr_image.header.seq, _x.action_result.result.hdr_image.header.stamp.secs, _x.action_result.result.hdr_image.header.stamp.nsecs))
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_2I.pack(_x.action_result.result.hdr_image.height, _x.action_result.result.hdr_image.width))
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_BI.pack(_x.action_result.result.hdr_image.is_bigendian, _x.action_result.result.hdr_image.step))
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_struct_i.pack(self.action_feedback.feedback.curr_nr_images_taken))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.action_goal.goal.target_type,) = _struct_B.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sf'%length
      ...
      (self.action_goal.goal.exposure_given,) = _struct_B.unpack(str[start:end])
      ...
      (_x.action_goal.goal.exposure_fixed, _x.action_goal.goal.brightness_given,) = _struct_2B.unpack(str[start:end])
      ...
      (_x.action_goal.goal.brightness_continuous, _x.action_goal.goal.gain_given,) = _struct_2B.unpack(str[start:end])
      ...
      (_x.action_goal.goal.gain_fixed, _x.action_goal.goal.gamma_given,) = _struct_2B.unpack(str[start:end])
      ...
      (_x.action_result.result.hdr_image.header.seq, _x.action_result.result.hdr_image.header.stamp.secs, _x.action_result.result.hdr_image.header.stamp.nsecs,) = _struct_3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.action_result.result.hdr_image.height, _x.action_result.result.hdr_image.width,) = _struct_2I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.action_result.result.hdr_image.is_bigendian, _x.action_result.result.hdr_image.step,) = _struct_BI.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (self.action_feedback.feedback.curr_nr_images_taken,) = _struct_i.unpack(str[start:end])
      return self
