...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_2B.pack(_x.success, _x.is_sleeping))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.success, _x.is_sleeping,) = _struct_2B.unpack(str[start:end])
      ...
      (_x.min_binning_x, _x.max_binning_x, _x.current_binning_x, _x.min_binning_y, _x.max_binning_y, _x.current_binning_y, _x.max_framerate, _x.current_framerate, _x.min_exposure, _x.max_exposure, _x.current_exposure, _x.min_gain_in_cam_units, _x.max_gain_in_cam_units, _x.current_gain_in_cam_units, _x.min_gain, _x.max_gain, _x.current_gain, _x.min_gamma, _x.max_gamma, _x.current_gamma, _x.brightness_continuous, _x.gain_auto, _x.exposure_auto,) = _struct_6i14f3B.unpack(str[start:end])
