...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_2I.pack(_x.target_binning_x, _x.target_binning_y))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.target_binning_x, _x.target_binning_y,) = _struct_2I.unpack(str[start:end])
      return self
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_2IB.pack(_x.reached_binning_x, _x.reached_binning_y, _x.success))
    except struct.error as se: self._check_types(struct.error("%s: '%s' when writing '%s'" % (type(se), str(se), str(locals().get('_x', self)))))
    except TypeError as te: self._check_types(ValueError("%s: '%s' when writing '%s'" % (type(te), str(te), str(locals().get('_x', self)))))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.reached_binning_x, _x.reached_binning_y, _x.success,) = _struct_2IB.unpack(str[start:end])
